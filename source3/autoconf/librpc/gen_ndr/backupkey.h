...
struct bkrp_exported_RSA_key_pair {
	...
	DATA_BLOB prime1;/* [subcontext(0),subcontext_size(128),flag(LIBNDR_FLAG_REMAINING)] */
	...
	DATA_BLOB exponent2;/* [flag(LIBNDR_FLAG_REMAINING),subcontext_size(128),subcontext(0)] */
