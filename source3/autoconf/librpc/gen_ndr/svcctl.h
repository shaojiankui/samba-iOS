...
struct QUERY_SERVICE_CONFIG {
	...
	const char *executablepath;/* [range(0,8192),charset(UTF16),unique] */
	const char *loadordergroup;/* [range(0,8192),unique,charset(UTF16)] */
	uint32_t tag_id;
	const char *dependencies;/* [range(0,8192),charset(UTF16),unique] */
...
struct svcctl_ArgumentString {
	const char *string;/* [range(0,SC_MAX_ARGUMENT_LENGTH),charset(UTF16),unique] */
};
