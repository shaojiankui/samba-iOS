...
struct lsa_String {
	...
	const char *string;/* [size_is(size/2),charset(UTF16),length_is(length/2),unique] */
}/* [public] */;
...
struct lsa_AsciiStringLarge {
	...
	const char *string;/* [size_is(size),length_is(length),charset(DOS),unique] */
}/* [public] */;
...
struct lsa_DATA_BUF {
	uint32_t length;
	uint32_t size;
	uint8_t *data;/* [unique,size_is(size),length_is(length)] */
