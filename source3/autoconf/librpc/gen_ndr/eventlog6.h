...
union eventlog6_EvtRpcVariantUnion {
	...
	const char *stringVal;/* [charset(UTF16),unique,case(EvtRpcVarTypeString)] */
...
struct eventlog6_EvtRpcRegisterRemoteSubscription {
	struct {
		...
		const char *bookmarkXml;/* [range(0,MAX_RPC_BOOKMARK_LENGTH),charset(UTF16),unique] */
		uint32_t flags;
	} in;
...
struct eventlog6_EvtRpcRegisterLogQuery {
	struct {
		const char *path;/* [charset(UTF16),unique,range(0,MAX_RPC_CHANNEL_PATH_LENGTH)] */
...
struct eventlog6_EvtRpcExportLog {
	struct {
		struct policy_handle *control;/* [ref] */
		const char *channelPath;/* [charset(UTF16),unique,range(0,MAX_RPC_CHANNEL_NAME_LENGTH)] */
		const char *query;/* [ref,charset(UTF16),range(1,MAX_RPC_QUERY_LENGTH)] */
		const char *backupPath;/* [range(1,MAX_RPC_FILE_PATH_LENGTH),charset(UTF16),ref] */
		uint32_t flags;
	} in;
...
struct eventlog6_EvtRpcLocalizeExportLog {
	struct {
		struct policy_handle *control;/* [ref] */
		const char *logFilePath;/* [range(1,MAX_RPC_FILE_PATH_LENGTH),ref,charset(UTF16)] */
		uint32_t locale;
		uint32_t flags;
	} in;
...
struct eventlog6_EvtRpcQueryNext {
	...
	struct {
		...
		uint32_t **eventDataSizes;/* [range(0,MAX_RPC_RECORD_COUNT),size_is(,*numActualRecords),ref] */
		uint32_t *resultBufferSize;/* [ref] */
		uint8_t **resultBuffer;/* [range(0,MAX_RPC_BATCH_SIZE),size_is(,*resultBufferSize),ref] */
		WERROR result;
	} out;
...
struct eventlog6_EvtRpcGetChannelList {
	...
	struct {
		...
		const char ***channelPaths;/* [range(0,MAX_RPC_CHANNEL_COUNT),ref,size_is(,*numChannelPaths),charset(UTF16)] */
		WERROR result;
	} out;
...
struct eventlog6_EvtRpcGetPublisherList {
	...
	struct {
		...
		const char ***publisherIds;/* [range(0,MAX_RPC_PUBLISHER_COUNT),ref,charset(UTF16),size_is(,*numPublisherIds)] */
		WERROR result;
	} out;
...
struct eventlog6_EvtRpcGetPublisherListForChannel {
	...
	struct {
		uint32_t *numPublisherIds;/* [ref] */
		const char ***publisherIds;/* [ref,size_is(,*numPublisherIds),charset(UTF16),range(0,MAX_RPC_PUBLISHER_COUNT)] */
		WERROR result;
	} out;
