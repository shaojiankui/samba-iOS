...
struct DNS_RPC_RECORD {
	...
	uint32_t dwReserved;
	union DNS_RPC_DATA data;/* [subcontext_size(wDataLength),subcontext(0),switch_is(wType)] */
}/* [public] */;
...
union DNSSRV_RPC_UNION {
	...
	struct DNS_RPC_ZONE_LIST_DOTNET *ZoneList;/* [unique,case(DNSSRV_TYPEID_ZONE_LIST)] */
...
struct DnssrvEnumRecords {
	...
	struct {
		...
		struct DNS_RPC_RECORDS_ARRAY **pBuffer;/* [subcontext(4),subcontext_size(*pdwBufferLength),ref] */
		WERROR result;
	} out;
...
struct DnssrvEnumRecords2 {
	...
	struct {
		uint32_t *pdwBufferLength;/* [ref] */
		struct DNS_RPC_RECORDS_ARRAY **pBuffer;/* [ref,subcontext_size(*pdwBufferLength),subcontext(4)] */
		WERROR result;
	} out;
