...
struct drsuapi_DsGetNCChangesMSZIPCtr1 {
	...
	struct drsuapi_DsGetNCChangesCtr1TS *ts;/* [unique,subcontext(4),subcontext_size(compressed_length),compression(NDR_COMPRESSION_MSZIP,compressed_length,decompressed_length)] */
}/* [nopush] */;

struct drsuapi_DsGetNCChangesMSZIPCtr6 {
	uint32_t decompressed_length;
	uint32_t compressed_length;
	struct drsuapi_DsGetNCChangesCtr6TS *ts;/* [subcontext(4),compression(NDR_COMPRESSION_MSZIP,compressed_length,decompressed_length),subcontext_size(compressed_length),unique] */
}/* [nopush] */;

struct drsuapi_DsGetNCChangesXPRESSCtr1 {
	uint32_t decompressed_length;
	uint32_t compressed_length;
	struct drsuapi_DsGetNCChangesCtr1TS *ts;/* [subcontext_size(compressed_length),compression(NDR_COMPRESSION_XPRESS,compressed_length,decompressed_length),subcontext(4),unique] */
}/* [nopush] */;

struct drsuapi_DsGetNCChangesXPRESSCtr6 {
	uint32_t decompressed_length;
	uint32_t compressed_length;
	struct drsuapi_DsGetNCChangesCtr6TS *ts;/* [unique,subcontext_size(compressed_length),compression(NDR_COMPRESSION_XPRESS,compressed_length,decompressed_length),subcontext(4)] */
}/* [nopush] */;
...
struct drsuapi_DsGetNT4ChangeLog {
	...
	struct {
		uint32_t *level_out;/* [ref] */
		union drsuapi_DsGetNT4ChangeLogInfo *info;/* [switch_is(*level_out),ref] */
		WERROR result;
	} out;
...
struct drsuapi_DsAddEntry {
	...
	struct {
		uint32_t *level_out;/* [ref] */
		union drsuapi_DsAddEntryCtr *ctr;/* [switch_is(*level_out),ref] */
		WERROR result;
	} out;
...
struct drsuapi_DsExecuteKCC {
	struct {
		struct policy_handle *bind_handle;/* [ref] */
		uint32_t level;
		union drsuapi_DsExecuteKCCRequest *req;/* [switch_is(level),ref] */
	} in;
