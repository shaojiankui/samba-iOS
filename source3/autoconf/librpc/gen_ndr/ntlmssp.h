...
struct NEGOTIATE_MESSAGE {
	...
	const char * DomainName;/* [subcontext_size(DomainNameLen),subcontext(0),relative,flag(ndr_ntlmssp_negotiated_string_flags(NTLMSSP_NEGOTIATE_OEM))] */
	uint16_t WorkstationLen;/* [value(Workstation?strlen(Workstation):0)] */
	uint16_t WorkstationMaxLen;/* [value(WorkstationLen)] */
	const char * Workstation;/* [subcontext(0),subcontext_size(WorkstationLen),relative,flag(ndr_ntlmssp_negotiated_string_flags(NTLMSSP_NEGOTIATE_OEM))] */
...
struct AV_PAIR_LIST {
	uint32_t count;
	struct AV_PAIR *pair;
}/* [nopush,gensize,flag(LIBNDR_FLAG_NOALIGN),nopull] */;
...
struct CHALLENGE_MESSAGE {
	...
	const char * TargetName;/* [subcontext_size(TargetNameLen),subcontext(0),flag(ndr_ntlmssp_negotiated_string_flags(r->NegotiateFlags)),relative] */
	uint32_t NegotiateFlags;
...
struct AUTHENTICATE_MESSAGE {
	...
	union ntlmssp_LM_RESPONSE *LmChallengeResponse;/* [subcontext_size(LmChallengeResponseLen),subcontext(0),switch_is(LmChallengeResponseLen),relative] */
	...
	uint16_t DomainNameMaxLen;/* [value(DomainNameLen)] */
	const char * DomainName;/* [subcontext_size(DomainNameLen),subcontext(0),relative,flag(ndr_ntlmssp_negotiated_string_flags(r->NegotiateFlags))] */
	uint16_t UserNameLen;/* [value(ndr_ntlmssp_string_length(NegotiateFlags,UserName))] */
	uint16_t UserNameMaxLen;/* [value(UserNameLen)] */
	const char * UserName;/* [flag(ndr_ntlmssp_negotiated_string_flags(r->NegotiateFlags)),relative,subcontext_size(UserNameLen),subcontext(0)] */
	uint16_t WorkstationLen;/* [value(ndr_ntlmssp_string_length(NegotiateFlags,Workstation))] */
	uint16_t WorkstationMaxLen;/* [value(WorkstationLen)] */
	const char * Workstation;/* [subcontext_size(WorkstationLen),subcontext(0),flag(ndr_ntlmssp_negotiated_string_flags(r->NegotiateFlags)),relative] */
