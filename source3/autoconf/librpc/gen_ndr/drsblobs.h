...
}/* [flag(LIBNDR_PRINT_ARRAY_HEX),public,gensize] */;
...
struct package_PrimaryKerberosString {
	...
	const char * string;/* [relative,flag(LIBNDR_FLAG_STR_NOTERM|LIBNDR_FLAG_REMAINING),subcontext_size(size),subcontext(0)] */
};
...
struct package_PrimaryKerberosKey3 {
	...
	DATA_BLOB *value;/* [relative,flag(LIBNDR_FLAG_REMAINING),subcontext(0),subcontext_size(value_len)] */
};
...
struct ExtendedErrorAString {
	uint16_t __size;
	const char *string;/* [size_is(__size),charset(DOS),unique] */
};
...
}/* [public,flag(LIBNDR_FLAG_NOALIGN),gensize] */;
