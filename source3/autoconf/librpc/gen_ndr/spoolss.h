...
}/* [gensize,flag(LIBNDR_FLAG_RELATIVE_REVERSE),public,relative_base,nodiscriminant] */;
...
}/* [gensize,relative_base,public,flag(LIBNDR_FLAG_RELATIVE_REVERSE),nodiscriminant] */;
...
struct spoolss_DriverInfo101 {
	...
	const char * driver_name;/* [relative,flag(LIBNDR_FLAG_STR_NULLTERM|LIBNDR_FLAG_ALIGN2)] */
	const char * architecture;/* [relative,flag(LIBNDR_FLAG_STR_NULLTERM|LIBNDR_FLAG_ALIGN2)] */
	struct spoolss_DriverFileInfo *file_info;/* [size_is(file_count),relative,flag(LIBNDR_FLAG_ALIGN4)] */
	uint32_t file_count;
	const char * monitor_name;/* [flag(LIBNDR_FLAG_STR_NULLTERM|LIBNDR_FLAG_ALIGN2),relative] */
	const char * default_datatype;/* [flag(LIBNDR_FLAG_STR_NULLTERM|LIBNDR_FLAG_ALIGN2),relative] */
	const char ** previous_names;/* [relative,flag(LIBNDR_FLAG_STR_NULLTERM|LIBNDR_FLAG_ALIGN2)] */
...
}/* [nodiscriminant,relative_base,flag(LIBNDR_FLAG_RELATIVE_REVERSE),public,gensize] */;
...
}/* [gensize,flag(LIBNDR_FLAG_RELATIVE_REVERSE),relative_base,public,nodiscriminant] */;
...
}/* [public,relative_base,flag(LIBNDR_FLAG_RELATIVE_REVERSE),nodiscriminant] */;
...
}/* [nodiscriminant,gensize,public,flag(LIBNDR_FLAG_RELATIVE_REVERSE),relative_base] */;
...
}/* [nodiscriminant,flag(LIBNDR_FLAG_RELATIVE_REVERSE),public,relative_base,gensize] */;
...
}/* [relative_base,public,flag(LIBNDR_FLAG_RELATIVE_REVERSE),nodiscriminant] */;
...
struct spoolss_PrinterEnumValues {
	...
	DATA_BLOB *data;/* [subcontext(0),subcontext_size(data_length),relative,flag(LIBNDR_FLAG_REMAINING|ndr_spoolss_PrinterEnumValues_align(r->type))] */
	uint32_t data_length;/* [value(data?data->length:0)] */
}/* [relative_base,public,gensize] */;
...
struct spoolss_GetJob {
	...
	struct {
		union spoolss_JobInfo *info;/* [switch_is(level),subcontext(4),subcontext_size(offered),unique] */
		uint32_t *needed;/* [ref] */
		WERROR result;
	} out;
...
struct spoolss_GetPrinter {
	...
	struct {
		union spoolss_PrinterInfo *info;/* [subcontext_size(offered),subcontext(4),switch_is(level),unique] */
		uint32_t *needed;/* [ref] */
		WERROR result;
	} out;
...
struct spoolss_EnumPrinterDrivers {
	...
	struct {
		uint32_t *count;/* [ref] */
		union spoolss_DriverInfo **info;/* [switch_is(level),size_is(,*count),ref] */
		uint32_t *needed;/* [ref] */
		WERROR result;
	} out;
...
struct spoolss_GetPrinterDriverDirectory {
	...
	struct {
		union spoolss_DriverDirectoryInfo *info;/* [switch_is(level),subcontext_size(offered),subcontext(4),unique] */
		uint32_t *needed;/* [ref] */
		WERROR result;
	} out;
...
struct spoolss_GetPrintProcessorDirectory {
	...
	struct {
		union spoolss_PrintProcessorDirectoryInfo *info;/* [unique,switch_is(level),subcontext(4),subcontext_size(offered)] */
		uint32_t *needed;/* [ref] */
		WERROR result;
	} out;
...
struct spoolss_GetForm {
	...
	struct {
		union spoolss_FormInfo *info;/* [switch_is(level),subcontext_size(offered),subcontext(4),unique] */
		uint32_t *needed;/* [ref] */
		WERROR result;
	} out;
...
struct spoolss_EnumPorts {
	...
	struct {
		uint32_t *count;/* [ref] */
		union spoolss_PortInfo **info;/* [switch_is(level),ref,size_is(,*count)] */
		uint32_t *needed;/* [ref] */
		WERROR result;
	} out;
...
struct spoolss_EnumMonitors {
	...
	struct {
		uint32_t *count;/* [ref] */
		union spoolss_MonitorInfo **info;/* [switch_is(level),size_is(,*count),ref] */
		uint32_t *needed;/* [ref] */
		WERROR result;
	} out;
...
struct spoolss_EnumPrintProcDataTypes {
	...
	struct {
		uint32_t *count;/* [ref] */
		union spoolss_PrintProcDataTypesInfo **info;/* [size_is(,*count),ref,switch_is(level)] */
		uint32_t *needed;/* [ref] */
		WERROR result;
	} out;
...
struct spoolss_GetPrinterDriver2 {
	...
	struct {
		union spoolss_DriverInfo *info;/* [switch_is(level),subcontext_size(offered),subcontext(4),unique] */
		uint32_t *needed;/* [ref] */
...
struct spoolss_EnumPrinterData {
	...
	struct {
		...
		enum winreg_Type *type;/* [ref] */
		uint8_t *data;/* [size_is(data_offered),flag(LIBNDR_PRINT_ARRAY_HEX),ref] */
...
struct spoolss_EnumPrinterDataEx {
	...
	struct {
		uint32_t *count;/* [ref] */
		struct spoolss_PrinterEnumValues **info;/* [size_is(,*count),ref] */
		uint32_t *needed;/* [ref] */
		WERROR result;
	} out;
...
struct spoolss_EnumPrinterKey {
	...
	struct {
		...
		union spoolss_KeyNames *key_buffer;/* [subcontext_size(*_ndr_size*2),subcontext(0),switch_is(*_ndr_size),ref] */
		uint32_t *needed;/* [ref] */
		WERROR result;
	} out;
...
struct spoolss_GetCorePrinterDrivers {
	struct {
		...
		const char *core_driver_dependencies;/* [charset(UTF16),size_is(core_driver_size),ref] */
